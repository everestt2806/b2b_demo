...
if($_SERVER["REQUEST_METHOD"]=="POST") {
    ...
    if(mysqli_num_rows($truyvan_ktTonTai)>0)
    {
        ...
        $themDuLieu = "INSERT INTO nhanvien(HoTen,TenDangNhap,MatKhau,role,NgaySinh,GioiTinh,DienThoai) VALUES ('" . $hoten . "','" . $tendangnhap . "',
        '" . $matkhau . "','" . $role . "','" . $ngaysinh . "','" . $gioitinh . "','" . $dienthoai . "')";
