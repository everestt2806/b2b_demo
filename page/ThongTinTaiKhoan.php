...
$layThongTin="SELECT * FROM khachhang WHERE TenDangNhap='".$_SESSION["tendangnhap"]."'";
...
<?php
    ...
    if($_SERVER["REQUEST_METHOD"]=="POST")
    {
        ...
        if(!filter_var($email,FILTER_VALIDATE_EMAIL))
            ...
            $capnhatThongTin="UPDATE khachhang SET HoTen='".$hoten."' ,NgaySinh='".$ngaysinh."', GioiTinh='".$gioitinh."',
